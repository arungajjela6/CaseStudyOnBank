...
public class EBill implements Comparable<EBill> {
	...
	@Column(name="ebill_minimumamountdue")
	private double minimumAmountDue;
	
	@Column(name="ebill_balance")
	private double balance;
	
	@Column(name="ebill_amountpaid")
	private double amountPaid;
	
	@Column(name="ebill_datepaid")
	@Temporal(TemporalType.DATE)
	private Date datePaid;
	
	@Column(name="ebill_receiveddate")
	@Temporal(TemporalType.DATE)
	private Date receivedDate;
	
	@Column(name="ebill_duedate")
	@Temporal(TemporalType.DATE)
	...
	@ManyToOne
	@JoinColumn(name="ebill_ebiller_id")
	private EBiller ebiller;
	
	@ManyToOne
	@JoinColumn(name="ebill_account_id")
