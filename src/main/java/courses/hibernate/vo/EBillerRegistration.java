...
@Entity
@Table(name = "ebillregistration")
public class EBillerRegistration {
	
	@Id
	@Column(name="ebillregistration_id")
	private long ebillerRegistrationId;
	
	@ManyToOne
	@JoinColumn(name="ebillregistration_account")
	private Account account;
	
	@ManyToOne
	@JoinColumn(name="ebillregistration_ebiller")
	private EBiller ebiller;
	
	@Column(name="ebillregistration_accountnumber")
	private String accountNumber;
	
	@Column(name="ebillregistration_date")
